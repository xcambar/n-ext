...
var nExtLoader = function() {
    ...
    this.bootstrapCore = function(sandbox) {
    	if (_ExtCache === null) {
	        ...
	        Ext.Loader.setPath('Ext', _libPath + '/Ext/src'); //@TODO Fix the crappy loader hack
     ...
     */
    this.enableNSAutoloader = function() {
        require.paths.unshift(_libPath);
    }
